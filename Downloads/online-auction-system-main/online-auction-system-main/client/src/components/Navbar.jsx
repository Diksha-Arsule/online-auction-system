...
export const Navbar = () => {
  ...
  // normalize user data returned from API: auth state stores payload as { user: { ... } }
  const userData = user?.user ?? null;
  const userRole = userData?.role ?? null;
  // defensive links array to avoid runtime map on undefined
  const desktopLinks = (userRole ? getNavLinks(userRole) : navMenu) ?? [];
